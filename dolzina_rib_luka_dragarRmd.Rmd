...
dolomieu). Podatke smo zapisali v dokument, ki ima 2 stolpce:
\begin{enumerate}
\item $dolzina$ dolzina je numericna zvezna spremenljivka, ki predstavlja dolzino telesa (v milimetrih).
\item $rlusk$ rlusk je numericna zvezna spremenljivka, ki predstavlja radij lusk (v milimetrih).
...
ylab="dolzine ribe (mm)", xlab="radija lusk (mm)", lwd=2, axes=FALSE)
...
Vrednost vzorčnega koeficienta korelacije je visoka ($r=0.9221425$), kar govori o visoki linearni povezanosti radija lusk in dolzine ribe. Dalje, koeficient korelacije je pozitiven, kar pomeni, da imajo ribe z vecjo dolzino vecji radij lusk manjše dolzine pa manjsi premer lusk.Koeficient korelacijej e sicer se kar visok, a v primerjavi s transformiranimi podatki($r=0.9351461$) opazimo padec povezanosti nasih podatkov.
